...
describe('commands/helpers', () => {
  ...
  describe('printCommandDetail', () => {
    ...
    it('should print details for command with optional parameters', () => {
      const consoleLogSpy = vi.spyOn(console, 'log').mockImplementation(() => {});

      printCommandDetail('list-pages');

      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('list-pages'));
      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('spaceKey (optional)'));
      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('title (optional)'));
      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('limit (optional)'));
